  ...
  return Promise.all([
    ...
    .then(function () {
      return Promise.all([
        ...
        knex('dishes').insert({id: 7, name: 'White Chocolate Raspberry Cheesecake', description: 'Cheesecake + raspberry + white chocolate = heaven', price: 9.99, type: 'dessert'}),
        knex('dishes').insert({id: 8, name: 'Reeses Peanut Butter Cheesecake', description: 'Reese and cheesecake? Nothing can go wrong', price: 13.50, type: 'dessert'}),
